...
# ld_map
#-----------------------------------------------------------------------------
# plots a plate heatmap of the first dimension of linear discriminant analysis
# as separated by specified groups
#
# note: can't really see any use for this.
#
# arguments:
#           - 'data': column of values to pass to MASS::lda()
#           - 'well': column of well identifying labels
#           - 'group': name of column containing group names to separate via lda
###############################################################################

ld_map <- function(data, well, group, title = "", palette = "Spectral"){
